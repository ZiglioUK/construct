...
//      assertEquals( (Container)obj, Container( "length", 3, "inner", Container( "inner_length", 2, "data", ByteArray(0xA,0xB,0xC,0xD,0xE))) ); 
  ...
  public void switchTest(){
  	...
  	switchstruct = Switch("switch", new KeyFunc(){ public Object get(Container context){return 5;}}, 
  			                  1, UBInt8("x"),5, UBInt16("y"));
  	assertEquals( 2, switchstruct.parse(ByteArray(0,2)));

  	switchstruct = Switch("switch", new KeyFunc(){ public Object get(Container context){return 6;}}, 
