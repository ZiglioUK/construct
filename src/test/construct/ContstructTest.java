...
*/
  ...
  public void structTest5() {
  	  Struct foo = Struct( "foo", UBInt8("c"), UBInt8("d") );
  	  Struct struct = Struct( "struct", UBInt8("a"), UBInt16("b"), foo );
  	  byte[] ba = struct.build( Container( P("a",1), P("b", 2), P("foo", Container(P("c", 3), P("d",4)))));
